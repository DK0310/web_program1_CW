        ...
        <?php foreach ($comments as $comment): ?>
            <div class="comment">
                <?php if (!empty($comment['avatar_path']) && file_exists($comment['avatar_path'])): ?>
                    <img src="<?= htmlspecialchars($comment['avatar_path'], ENT_QUOTES, 'UTF-8') ?>" alt="Avatar" class="avatar-img" style="width:40px;height:40px;border-radius:50%;object-fit:cover;">
                <?php else: ?>
